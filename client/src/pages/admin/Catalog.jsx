		...
		<div>
			...
			<section className='px-5 sm:px-5  lg:px-24 mt-3'>
				<div className='bg-green-100 h-16 px-5 py-3 shadow-md flex items-center gap-2'>
					...
					<div>
						<p className='text-green-700 font-bold text-base'>Book Catalogs</p>
					</div>
				</div>
			</section>
							...
							<table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
								...
								<tbody>
									{isLoading ? (
										...
										admins.slice().map((admin, index) => (
											<tr
												key={admin.id}
												className='border-b dark:border-gray-700 hover:bg-gray-100'>
												<td className='px-4 py-3'>{index + 1}</td>

												<td className='px-4 py-3'>{`${admin.firstname} ${admin.middlename || ''} ${admin.lastname}`}</td>
